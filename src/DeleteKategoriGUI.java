 ...
 * @author Mad
 */
public class DeleteKategoriGUI extends javax.swing.JDialog {
    public database db = new database();
    /**
     * Creates new form TambahKategoriGUI
     */
    public DeleteKategoriGUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        GUI.conKategori.kategoriComboDelete(this);
    }
    ...
    private void initComponents() {
        ...
        comboKategori.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BDG-1", "JKT-1", "BDG-2" }));
        ...
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addComponent(comboKategori, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        buttonDelete.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        buttonDelete.setText("Delete Kategori");
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        ...
        GUI.conKategori.deleteKategori(comboKategori.getSelectedItem().toString());
        this.dispose();
